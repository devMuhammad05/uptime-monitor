...
describe('GET /api/monitors/{id}/history', function (): void {
    ...
    it('returns 200 with empty data when monitor has no checks', function (): void {
        ...
        $this->getJson("/api/monitors/{$monitor->id}/history")
            ->assertStatus(200)
            ->assertJsonPath('data', [])
    ...
    it('returns correct meta for paginated results', function (): void {
        ...
        $this->getJson("/api/monitors/{$monitor->id}/history?per_page=5")
            ->assertStatus(200)
    ...
    it('respects the page query parameter', function (): void {
        ...
        $this->getJson("/api/monitors/{$monitor->id}/history?per_page=5&page=2")
            ->assertStatus(200)
            ->assertJsonCount(5, 'data')
    ...
    it('caps per_page at 100', function (): void {
        ...
        $this->getJson("/api/monitors/{$monitor->id}/history?per_page=200")
            ->assertStatus(200)
